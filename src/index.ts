...
export const getResolvers = (clientProps: ClientProps) => {
    return {
        ...
        getSummaryDataForBraintree: getSummaryDataForBraintree(clientProps),
        ...
        addWishlistProductToCart: addWishlistProductToCart(clientProps),
